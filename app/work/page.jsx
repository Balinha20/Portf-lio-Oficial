...
const projects = [
    {
        ...
        category: "front-end",
        title: "Project 1",
        description: "Site MicroService",
        stack: [{name: "Html 5"}, {name: "Css 3"}, {name: "JavaScript"}],
        image: "/photo/msi.png",
        live: "https://www.microserviceap.com.br/",
    },
    {
        num: "02",
        category: "front-end",
        title: "Project 2",
        description: "Site Lab. Dr. Lacyr",
        stack: [{name: "Html 5"}, {name: "Css 3"}, {name: "JavaScript"}],
        image: "/photo/lac.png",
        live: "https://www.labdrlacyr.com.br/",
    },
]
const Work = () => {
                      ...
                      {project.stack.map((item, index)=> {
                        return(
                            <li key={index} className="text-xl text-accent">
                             {item.name}
                             {/* codigo debaixo serviu para remover a ultima "," */}
                ...
                <div className="w-full xl:w-[50%]">
                  ...
                  >
                    ...
                    <WorkSliderBtns 
                     ...
                     w-[44px] h-[44x] flex justify-center items-center transition-all"
                    />
                  </Swiper>
                </div>
            </div>
